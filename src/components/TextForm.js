...
export default function TestForm(props) {
    ...
    return (
        <>
            ...
            <div className={`container row my-2 text-${props.mode === "light" ? "dark" : "light"}`}>
                <div className='col-md-6'><h2>Your test Summary</h2>
                <p>{wordCount()} words, {charCount()} characters</p>
                <p>Time to read: {wordCount() / 125} minutes</p></div>
                
                <div className='col-md-5'><h2>Preview</h2>
                <p>{wordCount() > 0 ? text : "Enter something in the box to see preview"}</p></div>
